...
export const createProject = async(req,res,next) => {
    try{
        ...
        if(userInfo.userRole == 'superAdmin'){
            let {userName:createrName,userEmail:createrEmail,userId:superAdminId} = userInfo;
            let project = {
                name,
                description,
                superAdminId,
            ...
            let {userName:createrName,userEmail:createrEmail,userId:createrId,userSuperAdminId:superAdminId} = userInfo;
            let project = {
                name,
                description,
                superAdminId,
